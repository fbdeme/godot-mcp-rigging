...
func _initialize_command_processors():
	...
	var rigging_commands = MCPRiggingCommands.new()
	...
	rigging_commands._websocket_server = _websocket_server
	...
	_command_processors.append(rigging_commands)
